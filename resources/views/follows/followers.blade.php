<x-app-layout>
    {{-- En-tête avec le titre et le compteur d'abonnés --}}
    <div class="py-6">
        ...
        <div class="container mx-auto sm:px-4">
            {{-- Message affiché si aucun abonné --}}
            ...
            @else
                {{-- Grille responsive des abonnés --}}
                <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach ($followers as $follow)
                        {{-- Carte utilisateur avec avatar, stats et bouton suivre conditionnel --}}
                        <div
