<div class="px-4 sm:px-8">
    {{-- Conteneur principal de recherche avec Alpine.js pour la gestion d'état --}}
    <div x-data="{
        query: (() => {
        ...
        x-transition:leave-end="opacity-0 transform -translate-y-2" class="w-full max-w-3xl py-6 mx-auto">

        {{-- Formulaire de recherche avec style Tailwind --}}
        <form @submit.prevent="handleSearch"
            class="flex items-center w-full gap-2 p-4 bg-gray-800 rounded-lg shadow-lg">
            ...
            {{-- Bouton de soumission avec icône de recherche --}}
